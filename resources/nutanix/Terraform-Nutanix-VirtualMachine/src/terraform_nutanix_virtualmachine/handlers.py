...
TYPE_NAME = "Terraform::Nutanix::VirtualMachine"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["ApiVersion", "ClusterName", "HostReference", "HypervisorType", "Id", "Metadata", "NicListStatus", "PowerState", "State"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'nutanix',
                'terraformTypeName': 'nutanix_virtual_machine',
            }).encode(),
        )
