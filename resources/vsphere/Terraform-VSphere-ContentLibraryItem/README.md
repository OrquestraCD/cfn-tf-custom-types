# Terraform::VSphere::ContentLibraryItem

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-vsphere-contentlibraryitem.json`
2. Implement your resource handlers in `terraform_vsphere_contentlibraryitem/handlers.py`
