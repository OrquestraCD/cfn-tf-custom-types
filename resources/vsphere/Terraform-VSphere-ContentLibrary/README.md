# Terraform::VSphere::ContentLibrary

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-vsphere-contentlibrary.json`
2. Implement your resource handlers in `terraform_vsphere_contentlibrary/handlers.py`
