...
TYPE_NAME = "Terraform::VSphere::VirtualMachine"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["ChangeVersion", "DefaultIpAddress", "GuestIpAddresses", "Id", "Imported", "Moid", "RebootRequired", "Uuid", "VappTransport", "VmwareToolsStatus", "VmxPath"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'vsphere',
                'terraformTypeName': 'vsphere_virtual_machine',
            }).encode(),
        )
