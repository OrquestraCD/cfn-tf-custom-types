...
TYPE_NAME = "Terraform::Gitlab::ProjectCluster"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["ClusterType", "CreatedAt", "Id", "PlatformType", "ProviderType"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'gitlab',
                'terraformTypeName': 'gitlab_project_cluster',
            }).encode(),
        )
