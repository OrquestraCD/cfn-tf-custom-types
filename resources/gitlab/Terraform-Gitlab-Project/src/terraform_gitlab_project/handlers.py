...
TYPE_NAME = "Terraform::Gitlab::Project"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["HttpUrlToRepo", "Id", "RunnersToken", "SshUrlToRepo", "WebUrl"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'gitlab_project',
            }).encode(),
        )
