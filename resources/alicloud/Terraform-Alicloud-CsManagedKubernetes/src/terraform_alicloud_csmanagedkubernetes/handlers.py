...
TYPE_NAME = "Terraform::Alicloud::CsManagedKubernetes"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Connections", "Id", "NatGatewayId", "SecurityGroupId", "SlbId", "SlbInternet", "SlbIntranet", "VpcId", "WorkerNodes"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'alicloud',
                'terraformTypeName': 'alicloud_cs_managed_kubernetes',
            }).encode(),
        )
