...
TYPE_NAME = "Terraform::Alicloud::RouterInterface"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AccessPointId", "Id", "OppositeInterfaceId", "OppositeInterfaceOwnerId", "OppositeRouterId", "OppositeRouterType"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'alicloud_router_interface',
            }).encode(),
        )
