...
TYPE_NAME = "Terraform::Mailgun::Domain"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "ReceivingRecords", "SendingRecords", "SmtpLogin", "SmtpPassword"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'mailgun',
                'terraformTypeName': 'mailgun_domain',
            }).encode(),
        )
