...
TYPE_NAME = "Terraform::Packet::Device"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AccessPrivateIpv4", "AccessPublicIpv4", "AccessPublicIpv6", "Created", "DeployedFacility", "Id", "IpAddressTypes", "Locked", "Network", "Ports", "RootPassword", "SshKeyIds", "State", "Updated"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'packet',
                'terraformTypeName': 'packet_device',
            }).encode(),
        )
