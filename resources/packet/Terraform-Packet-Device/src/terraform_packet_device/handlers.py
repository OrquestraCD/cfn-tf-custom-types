    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["AccessPrivateIpv4", "AccessPublicIpv4", "AccessPublicIpv6", "Created", "DeployedFacility", "Id", "IpAddressTypes", "Locked", "Network", "Ports", "RootPassword", "SshKeyIds", "State", "Updated"],
            }).encode(),
        )
