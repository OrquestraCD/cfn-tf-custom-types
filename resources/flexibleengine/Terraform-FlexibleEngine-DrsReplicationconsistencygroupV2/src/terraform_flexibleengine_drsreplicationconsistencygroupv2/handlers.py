...
TYPE_NAME = "Terraform::FlexibleEngine::DrsReplicationconsistencygroupV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CreatedAt", "FailureDetail", "FaultLevel", "Id", "ReplicationStatus", "Status", "UpdatedAt"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'flexibleengine_drs_replicationconsistencygroup_v2',
            }).encode(),
        )
