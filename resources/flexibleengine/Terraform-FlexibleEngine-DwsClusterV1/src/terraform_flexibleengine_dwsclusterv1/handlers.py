...
TYPE_NAME = "Terraform::FlexibleEngine::DwsClusterV1"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Created", "Endpoints", "Id", "PublicEndpoints", "Status", "SubStatus", "TaskStatus", "Updated", "Version"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'flexibleengine_dws_cluster_v1',
            }).encode(),
        )
