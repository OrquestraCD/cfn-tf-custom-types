...
TYPE_NAME = "Terraform::FlexibleEngine::SdrsProtectedinstanceV1"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "TargetServer"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'flexibleengine_sdrs_protectedinstance_v1',
            }).encode(),
        )
