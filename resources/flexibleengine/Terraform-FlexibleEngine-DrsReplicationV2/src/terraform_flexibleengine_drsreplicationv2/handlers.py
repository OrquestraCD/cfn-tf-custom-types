...
TYPE_NAME = "Terraform::FlexibleEngine::DrsReplicationV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CreatedAt", "FailureDetail", "FaultLevel", "Id", "Progress", "RecordMetadata", "ReplicationConsistencyGroupId", "ReplicationStatus", "Status", "UpdatedAt"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'flexibleengine_drs_replication_v2',
            }).encode(),
        )
