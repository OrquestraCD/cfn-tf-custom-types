...
TYPE_NAME = "Terraform::FlexibleEngine::CceClusterV3"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CertificateClusters", "CertificateUsers", "ExternalApigEndpoint", "ExternalEndpoint", "Id", "InternalEndpoint", "SecurityGroupId", "Status"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'flexibleengine_cce_cluster_v3',
            }).encode(),
        )
