...
TYPE_NAME = "Terraform::OCI::ContainerengineCluster"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AvailableKubernetesUpgrades", "Endpoints", "Id", "LifecycleDetails", "Metadata", "State"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oci_containerengine_cluster',
            }).encode(),
        )
