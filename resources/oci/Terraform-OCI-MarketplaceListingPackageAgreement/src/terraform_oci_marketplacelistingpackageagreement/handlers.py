...
TYPE_NAME = "Terraform::OCI::MarketplaceListingPackageAgreement"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Author", "CompartmentId", "ContentUrl", "Id", "Prompt", "Signature"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oci_marketplace_listing_package_agreement',
            }).encode(),
        )
