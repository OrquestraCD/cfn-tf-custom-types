...
TYPE_NAME = "Terraform::OCI::DatabaseAutonomousDatabaseRegionalWalletManagement"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oci_database_autonomous_database_regional_wallet_management',
            }).encode(),
        )
