    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["ConnectionStrings", "ConnectionUrls", "Id", "IsPreview", "LifecycleDetails", "PrivateEndpoint", "ServiceConsoleUrl", "State", "SystemTags", "TimeCreated", "TimeDeletionOfFreeAutonomousDatabase", "TimeMaintenanceBegin", "TimeMaintenanceEnd", "TimeReclamationOfFreeAutonomousDatabase", "UsedDataStorageSizeInTbs"],
            }).encode(),
        )
