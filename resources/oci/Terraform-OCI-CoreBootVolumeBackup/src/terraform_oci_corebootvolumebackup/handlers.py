    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["ExpirationTime", "Id", "ImageId", "KmsKeyId", "SizeInGbs", "SourceBootVolumeBackupId", "SourceType", "State", "SystemTags", "TimeCreated", "TimeRequestReceived", "UniqueSizeInGbs"],
            }).encode(),
        )
