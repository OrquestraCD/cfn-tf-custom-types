    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["Id", "IormConfigCache", "LastPatchHistoryEntryId", "LifecycleDetails", "ListenerPort", "RecoStorageSizeInGb", "ScanDnsRecordId", "ScanIpIds", "State", "TimeCreated", "Version", "VipIds"],
            }).encode(),
        )
