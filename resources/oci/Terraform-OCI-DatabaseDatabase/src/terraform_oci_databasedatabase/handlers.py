...
TYPE_NAME = "Terraform::OCI::DatabaseDatabase"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CharacterSet", "CompartmentId", "ConnectionStrings", "DbBackupConfig", "DbName", "DbSystemId", "DbUniqueName", "DbWorkload", "DefinedTags", "FreeformTags", "Id", "LifecycleDetails", "NcharacterSet", "PdbName", "State", "TimeCreated", "VmClusterId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oci_database_database',
            }).encode(),
        )
