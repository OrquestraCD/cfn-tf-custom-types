    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["CharacterSet", "CompartmentId", "ConnectionStrings", "DbBackupConfig", "DbName", "DbSystemId", "DbUniqueName", "DbWorkload", "DefinedTags", "FreeformTags", "Id", "LifecycleDetails", "NcharacterSet", "PdbName", "State", "TimeCreated", "VmClusterId"],
            }).encode(),
        )
