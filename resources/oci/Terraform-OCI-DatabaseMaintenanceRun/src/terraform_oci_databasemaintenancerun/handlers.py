...
TYPE_NAME = "Terraform::OCI::DatabaseMaintenanceRun"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CompartmentId", "Description", "DisplayName", "Id", "LifecycleDetails", "MaintenanceSubtype", "MaintenanceType", "State", "TargetResourceId", "TargetResourceType", "TimeEnded", "TimeScheduled", "TimeStarted"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oci_database_maintenance_run',
            }).encode(),
        )
