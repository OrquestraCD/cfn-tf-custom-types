    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["CompartmentId", "Description", "DisplayName", "Id", "LifecycleDetails", "MaintenanceSubtype", "MaintenanceType", "State", "TargetResourceId", "TargetResourceType", "TimeEnded", "TimeScheduled", "TimeStarted"],
            }).encode(),
        )
