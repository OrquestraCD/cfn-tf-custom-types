...
TYPE_NAME = "Terraform::OCI::DatabaseBackup"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oci_database_backup',
                'returnValues': ["AvailabilityDomain", "CompartmentId", "DatabaseEdition", "DatabaseSizeInGbs", "Id", "LifecycleDetails", "Shape", "State", "TimeEnded", "TimeStarted", "Type"],
            }).encode(),
        )
