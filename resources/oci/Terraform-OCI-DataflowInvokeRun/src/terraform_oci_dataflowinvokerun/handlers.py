    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["ClassName", "DataReadInBytes", "DataWrittenInBytes", "FileUri", "Id", "Language", "LifecycleDetails", "OpcRequestId", "OwnerPrincipalId", "OwnerUserName", "RunDurationInMilliseconds", "SparkVersion", "State", "TimeCreated", "TimeUpdated", "TotalOcpu"],
            }).encode(),
        )
