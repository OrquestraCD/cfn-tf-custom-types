...
TYPE_NAME = "Terraform::OCI::CoreIpsecConnectionTunnelManagement"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CompartmentId", "CpeIp", "Id", "State", "Status", "TimeCreated", "TimeStatusUpdated", "VpnIp"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oci_core_ipsec_connection_tunnel_management',
            }).encode(),
        )
