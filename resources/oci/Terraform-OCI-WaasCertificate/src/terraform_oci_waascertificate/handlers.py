    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["Extensions", "Id", "IssuedBy", "IssuerName", "PublicKeyInfo", "SerialNumber", "SignatureAlgorithm", "State", "SubjectName", "TimeCreated", "TimeNotValidAfter", "TimeNotValidBefore", "Version"],
            }).encode(),
        )
