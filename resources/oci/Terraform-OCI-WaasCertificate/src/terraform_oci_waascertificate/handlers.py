...
TYPE_NAME = "Terraform::OCI::WaasCertificate"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Extensions", "Id", "IssuedBy", "IssuerName", "PublicKeyInfo", "SerialNumber", "SignatureAlgorithm", "State", "SubjectName", "TimeCreated", "TimeNotValidAfter", "TimeNotValidBefore", "Version"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oci_waas_certificate',
            }).encode(),
        )
