...
TYPE_NAME = "Terraform::OCI::CoreVirtualNetwork"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["DefaultDhcpOptionsId", "DefaultRouteTableId", "DefaultSecurityListId", "Id", "Ipv6publicCidrBlock", "State", "TimeCreated", "VcnDomainName"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oci_core_virtual_network',
            }).encode(),
        )
