...
TYPE_NAME = "Terraform::OCI::OsmanagementSoftwareSource"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AssociatedManagedInstances", "GpgKeyFingerprint", "GpgKeyId", "GpgKeyUrl", "Id", "Packages", "ParentName", "RepoType", "State", "Status", "Url"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oci_osmanagement_software_source',
            }).encode(),
        )
