...
TYPE_NAME = "Terraform::OCI::DatascienceModel"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["ArtifactContentMd5", "ArtifactLastModified", "CreatedBy", "EmptyModel", "Id", "TimeCreated"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oci_datascience_model',
            }).encode(),
        )
