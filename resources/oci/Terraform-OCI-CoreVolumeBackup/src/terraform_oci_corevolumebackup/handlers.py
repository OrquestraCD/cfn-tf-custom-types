    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["ExpirationTime", "Id", "KmsKeyId", "SizeInGbs", "SizeInMbs", "SourceType", "SourceVolumeBackupId", "State", "SystemTags", "TimeCreated", "TimeRequestReceived", "UniqueSizeInGbs", "UniqueSizeInMbs"],
            }).encode(),
        )
