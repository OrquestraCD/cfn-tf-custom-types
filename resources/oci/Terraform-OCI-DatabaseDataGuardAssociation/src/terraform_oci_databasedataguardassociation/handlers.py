...
TYPE_NAME = "Terraform::OCI::DatabaseDataGuardAssociation"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["ApplyLag", "ApplyRate", "Id", "LifecycleDetails", "PeerDataGuardAssociationId", "PeerDatabaseId", "PeerDbHomeId", "PeerRole", "Role", "State", "TimeCreated"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oci_database_data_guard_association',
            }).encode(),
        )
