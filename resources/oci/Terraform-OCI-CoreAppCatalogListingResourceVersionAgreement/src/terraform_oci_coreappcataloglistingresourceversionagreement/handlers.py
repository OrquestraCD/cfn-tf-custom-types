...
TYPE_NAME = "Terraform::OCI::CoreAppCatalogListingResourceVersionAgreement"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["EulaLink", "Id", "OracleTermsOfUseLink", "Signature", "TimeRetrieved"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oci_core_app_catalog_listing_resource_version_agreement',
            }).encode(),
        )
