...
TYPE_NAME = "Terraform::OCI::CoreVolumeGroupBackup"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "SizeInGbs", "SizeInMbs", "State", "TimeCreated", "TimeRequestReceived", "UniqueSizeInGbs", "UniqueSizeInMbs", "VolumeBackupIds"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oci_core_volume_group_backup',
            }).encode(),
        )
