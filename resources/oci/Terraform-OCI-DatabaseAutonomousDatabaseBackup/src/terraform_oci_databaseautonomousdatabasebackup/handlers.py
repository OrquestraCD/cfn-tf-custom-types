...
TYPE_NAME = "Terraform::OCI::DatabaseAutonomousDatabaseBackup"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CompartmentId", "DatabaseSizeInTbs", "Id", "IsAutomatic", "IsRestorable", "LifecycleDetails", "State", "TimeEnded", "TimeStarted", "Type"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oci_database_autonomous_database_backup',
            }).encode(),
        )
