...
TYPE_NAME = "Terraform::ACME::Certificate"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CertificateDomain", "CertificateP12", "CertificatePem", "CertificateUrl", "Id", "IssuerPem", "PrivateKeyPem"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'acme',
                'terraformTypeName': 'acme_certificate',
            }).encode(),
        )
