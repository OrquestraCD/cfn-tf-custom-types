    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["Attributes", "AvailabilityDomain", "Domain", "Entry", "Fingerprint", "Fqdn", "Id", "ImageFormat", "IpAddress", "PlacementRequirements", "Platform", "Priority", "QuotaReservation", "Relationships", "Resolvers", "Site", "StartTime", "State", "Vcable", "Virtio", "VncAddress"],
            }).encode(),
        )
