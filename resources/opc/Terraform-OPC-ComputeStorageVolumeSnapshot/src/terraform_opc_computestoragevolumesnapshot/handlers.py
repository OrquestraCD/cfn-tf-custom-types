...
TYPE_NAME = "Terraform::OPC::ComputeStorageVolumeSnapshot"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Account", "Id", "MachineImageName", "Platform", "Property", "Size", "SnapshotId", "SnapshotTimestamp", "StartTimestamp", "Status", "StatusDetail", "StatusTimestamp", "Uri"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opc_compute_storage_volume_snapshot',
            }).encode(),
        )
