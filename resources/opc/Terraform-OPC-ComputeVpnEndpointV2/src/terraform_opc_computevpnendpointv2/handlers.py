...
TYPE_NAME = "Terraform::OPC::ComputeVpnEndpointV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "LocalGatewayIpAddress", "LocalGatewayPrivateIpAddress", "TunnelStatus", "Uri"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opc_compute_vpn_endpoint_v2',
            }).encode(),
        )
