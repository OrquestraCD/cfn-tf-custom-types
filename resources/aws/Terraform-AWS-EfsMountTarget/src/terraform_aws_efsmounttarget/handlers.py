...
TYPE_NAME = "Terraform::AWS::EfsMountTarget"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["DnsName", "FileSystemArn", "Id", "NetworkInterfaceId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_efs_mount_target',
            }).encode(),
        )
