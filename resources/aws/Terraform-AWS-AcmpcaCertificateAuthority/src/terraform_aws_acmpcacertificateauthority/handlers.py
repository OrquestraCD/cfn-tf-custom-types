...
TYPE_NAME = "Terraform::AWS::AcmpcaCertificateAuthority"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["Arn", "Certificate", "CertificateChain", "CertificateSigningRequest", "Id", "NotAfter", "NotBefore", "Serial", "Status"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_acmpca_certificate_authority',
            }).encode(),
        )
