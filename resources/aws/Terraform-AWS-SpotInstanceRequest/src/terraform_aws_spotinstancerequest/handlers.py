    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["Arn", "Id", "InstanceState", "NetworkInterfaceId", "PasswordData", "PrimaryNetworkInterfaceId", "PrivateDns", "PublicDns", "PublicIp", "SpotBidStatus", "SpotInstanceId", "SpotRequestState"],
            }).encode(),
        )
