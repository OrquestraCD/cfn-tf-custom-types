...
TYPE_NAME = "Terraform::AWS::VpnConnection"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_vpn_connection',
                'returnValues': ["CustomerGatewayConfiguration", "Id", "Routes", "TransitGatewayAttachmentId", "Tunnel1Address", "Tunnel1BgpAsn", "Tunnel1BgpHoldtime", "Tunnel1CgwInsideAddress", "Tunnel1VgwInsideAddress", "Tunnel2Address", "Tunnel2BgpAsn", "Tunnel2BgpHoldtime", "Tunnel2CgwInsideAddress", "Tunnel2VgwInsideAddress", "VgwTelemetry"],
            }).encode(),
        )
