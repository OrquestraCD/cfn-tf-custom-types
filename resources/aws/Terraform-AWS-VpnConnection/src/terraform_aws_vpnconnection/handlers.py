            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["CustomerGatewayConfiguration", "Id", "Routes", "TransitGatewayAttachmentId", "Tunnel1Address", "Tunnel1BgpAsn", "Tunnel1BgpHoldtime", "Tunnel1CgwInsideAddress", "Tunnel1VgwInsideAddress", "Tunnel2Address", "Tunnel2BgpAsn", "Tunnel2BgpHoldtime", "Tunnel2CgwInsideAddress", "Tunnel2VgwInsideAddress", "VgwTelemetry"] and getattr(progress.resourceModel, return_value_name) is None:
