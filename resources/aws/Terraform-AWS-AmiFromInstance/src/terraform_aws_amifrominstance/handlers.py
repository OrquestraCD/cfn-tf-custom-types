    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["Architecture", "EnaSupport", "Id", "ImageLocation", "KernelId", "ManageEbsSnapshots", "RamdiskId", "RootDeviceName", "RootSnapshotId", "SriovNetSupport", "VirtualizationType"],
            }).encode(),
        )
