...
TYPE_NAME = "Terraform::AWS::NeptuneClusterSnapshot"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AllocatedStorage", "AvailabilityZones", "DbClusterSnapshotArn", "Engine", "EngineVersion", "Id", "KmsKeyId", "LicenseModel", "Port", "SnapshotType", "SourceDbClusterSnapshotArn", "Status", "StorageEncrypted", "VpcId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_neptune_cluster_snapshot',
            }).encode(),
        )
