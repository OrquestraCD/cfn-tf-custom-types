    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["AllocatedStorage", "AvailabilityZones", "DbClusterSnapshotArn", "Engine", "EngineVersion", "Id", "KmsKeyId", "LicenseModel", "Port", "SnapshotType", "SourceDbClusterSnapshotArn", "Status", "StorageEncrypted", "VpcId"],
            }).encode(),
        )
