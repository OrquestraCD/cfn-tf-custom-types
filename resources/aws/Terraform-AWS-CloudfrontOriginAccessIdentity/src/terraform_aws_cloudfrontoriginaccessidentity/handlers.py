...
TYPE_NAME = "Terraform::AWS::CloudfrontOriginAccessIdentity"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["CallerReference", "CloudfrontAccessIdentityPath", "Etag", "IamArn", "Id", "S3CanonicalUserId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_cloudfront_origin_access_identity',
            }).encode(),
        )
