...
TYPE_NAME = "Terraform::AWS::LightsailInstance"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["Arn", "CpuCount", "CreatedAt", "Id", "Ipv6Address", "IsStaticIp", "PrivateIpAddress", "PublicIpAddress", "RamSize", "Username"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_lightsail_instance',
            }).encode(),
        )
