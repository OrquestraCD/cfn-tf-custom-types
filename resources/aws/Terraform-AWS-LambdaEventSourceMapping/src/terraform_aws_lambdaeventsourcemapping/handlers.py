...
TYPE_NAME = "Terraform::AWS::LambdaEventSourceMapping"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["FunctionArn", "Id", "LastModified", "LastProcessingResult", "State", "StateTransitionReason", "Uuid"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_lambda_event_source_mapping',
            }).encode(),
        )
