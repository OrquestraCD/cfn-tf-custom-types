...
TYPE_NAME = "Terraform::AWS::CodecommitRepository"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["Arn", "CloneUrlHttp", "CloneUrlSsh", "Id", "RepositoryId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_codecommit_repository',
            }).encode(),
        )
