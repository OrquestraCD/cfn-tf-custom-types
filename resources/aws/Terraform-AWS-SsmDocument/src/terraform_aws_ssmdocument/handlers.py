...
TYPE_NAME = "Terraform::AWS::SsmDocument"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["Arn", "CreatedDate", "DefaultVersion", "Description", "Hash", "HashType", "Id", "LatestVersion", "Owner", "Parameter", "PlatformTypes", "SchemaVersion", "Status"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_ssm_document',
            }).encode(),
        )
