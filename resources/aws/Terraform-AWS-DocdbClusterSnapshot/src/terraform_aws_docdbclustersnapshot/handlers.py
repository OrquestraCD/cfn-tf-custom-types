...
TYPE_NAME = "Terraform::AWS::DocdbClusterSnapshot"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["AvailabilityZones", "DbClusterSnapshotArn", "Engine", "EngineVersion", "Id", "KmsKeyId", "Port", "SnapshotType", "SourceDbClusterSnapshotArn", "Status", "StorageEncrypted", "VpcId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_docdb_cluster_snapshot',
            }).encode(),
        )
