    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["AvailabilityZones", "DbClusterSnapshotArn", "Engine", "EngineVersion", "Id", "KmsKeyId", "Port", "SnapshotType", "SourceDbClusterSnapshotArn", "Status", "StorageEncrypted", "VpcId"],
            }).encode(),
        )
