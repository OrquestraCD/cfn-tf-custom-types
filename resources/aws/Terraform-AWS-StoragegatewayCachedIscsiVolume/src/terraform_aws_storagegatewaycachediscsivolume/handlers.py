...
TYPE_NAME = "Terraform::AWS::StoragegatewayCachedIscsiVolume"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Arn", "ChapEnabled", "Id", "LunNumber", "NetworkInterfacePort", "TargetArn", "VolumeArn", "VolumeId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_storagegateway_cached_iscsi_volume',
            }).encode(),
        )
