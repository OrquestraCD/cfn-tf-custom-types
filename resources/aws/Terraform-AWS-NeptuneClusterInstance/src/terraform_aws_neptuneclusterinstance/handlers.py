...
TYPE_NAME = "Terraform::AWS::NeptuneClusterInstance"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["Address", "Arn", "DbiResourceId", "Endpoint", "Id", "KmsKeyArn", "StorageEncrypted", "Writer"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_neptune_cluster_instance',
            }).encode(),
        )
