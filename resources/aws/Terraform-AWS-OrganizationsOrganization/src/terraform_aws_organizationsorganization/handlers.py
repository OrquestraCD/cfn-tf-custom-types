...
TYPE_NAME = "Terraform::AWS::OrganizationsOrganization"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["Accounts", "Arn", "Id", "MasterAccountArn", "MasterAccountEmail", "MasterAccountId", "NonMasterAccounts", "Roots"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_organizations_organization',
            }).encode(),
        )
