    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["AllocatedStorage", "AvailabilityZone", "DbSnapshotArn", "Encrypted", "Engine", "EngineVersion", "Id", "Iops", "KmsKeyId", "LicenseModel", "OptionGroupName", "Port", "SnapshotType", "SourceDbSnapshotIdentifier", "SourceRegion", "Status", "StorageType", "VpcId"],
            }).encode(),
        )
