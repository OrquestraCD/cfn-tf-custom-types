...
TYPE_NAME = "Terraform::AWS::PinpointSmsChannel"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "PromotionalMessagesPerSecond", "TransactionalMessagesPerSecond"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_pinpoint_sms_channel',
            }).encode(),
        )
