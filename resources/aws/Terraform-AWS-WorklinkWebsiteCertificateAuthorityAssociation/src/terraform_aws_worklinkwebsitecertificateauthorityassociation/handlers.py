...
TYPE_NAME = "Terraform::AWS::WorklinkWebsiteCertificateAuthorityAssociation"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["Id", "WebsiteCaId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_worklink_website_certificate_authority_association',
            }).encode(),
        )
