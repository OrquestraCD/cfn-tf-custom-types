...
TYPE_NAME = "Terraform::AWS::VpcEndpoint"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["CidrBlocks", "DnsEntry", "Id", "NetworkInterfaceIds", "OwnerId", "PrefixListId", "RequesterManaged", "State"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_vpc_endpoint',
            }).encode(),
        )
