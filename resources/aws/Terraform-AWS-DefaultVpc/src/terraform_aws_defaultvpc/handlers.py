    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["Arn", "AssignGeneratedIpv6CidrBlock", "CidrBlock", "DefaultNetworkAclId", "DefaultRouteTableId", "DefaultSecurityGroupId", "DhcpOptionsId", "Id", "InstanceTenancy", "Ipv6AssociationId", "Ipv6CidrBlock", "MainRouteTableId", "OwnerId"],
            }).encode(),
        )
