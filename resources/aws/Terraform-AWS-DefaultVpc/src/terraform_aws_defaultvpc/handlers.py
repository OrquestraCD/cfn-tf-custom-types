...
TYPE_NAME = "Terraform::AWS::DefaultVpc"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["Arn", "AssignGeneratedIpv6CidrBlock", "CidrBlock", "DefaultNetworkAclId", "DefaultRouteTableId", "DefaultSecurityGroupId", "DhcpOptionsId", "Id", "InstanceTenancy", "Ipv6AssociationId", "Ipv6CidrBlock", "MainRouteTableId", "OwnerId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_default_vpc',
            }).encode(),
        )
