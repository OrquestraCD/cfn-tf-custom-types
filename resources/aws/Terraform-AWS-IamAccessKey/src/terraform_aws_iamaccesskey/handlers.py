...
TYPE_NAME = "Terraform::AWS::IamAccessKey"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["EncryptedSecret", "Id", "KeyFingerprint", "Secret", "SesSmtpPassword", "SesSmtpPasswordV4"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_iam_access_key',
            }).encode(),
        )
