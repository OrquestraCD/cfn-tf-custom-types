    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["Arn", "DefaultNetworkAclId", "DefaultRouteTableId", "DefaultSecurityGroupId", "DhcpOptionsId", "Id", "Ipv6AssociationId", "Ipv6CidrBlock", "MainRouteTableId", "OwnerId"],
            }).encode(),
        )
