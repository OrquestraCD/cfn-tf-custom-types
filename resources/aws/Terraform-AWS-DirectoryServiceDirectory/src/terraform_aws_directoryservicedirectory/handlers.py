...
TYPE_NAME = "Terraform::AWS::DirectoryServiceDirectory"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["AccessUrl", "DnsIpAddresses", "Id", "SecurityGroupId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_directory_service_directory',
            }).encode(),
        )
