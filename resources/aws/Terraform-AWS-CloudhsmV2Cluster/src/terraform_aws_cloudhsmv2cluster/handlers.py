...
TYPE_NAME = "Terraform::AWS::CloudhsmV2Cluster"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["ClusterCertificates", "ClusterId", "ClusterState", "Id", "SecurityGroupId", "VpcId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_cloudhsm_v2_cluster',
            }).encode(),
        )
