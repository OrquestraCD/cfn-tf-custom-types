    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["Arn", "DbSubnetGroupName", "DbiResourceId", "Endpoint", "EngineVersion", "Id", "KmsKeyId", "Port", "PreferredBackupWindow", "PubliclyAccessible", "StorageEncrypted", "Writer"],
            }).encode(),
        )
