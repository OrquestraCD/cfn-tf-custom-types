...
TYPE_NAME = "Terraform::AWS::LightsailKeyPair"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["Arn", "EncryptedFingerprint", "EncryptedPrivateKey", "Fingerprint", "Id", "PrivateKey"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_lightsail_key_pair',
            }).encode(),
        )
