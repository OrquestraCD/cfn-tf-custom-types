...
TYPE_NAME = "Terraform::AWS::VpcEndpointService"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["AvailabilityZones", "BaseEndpointDnsNames", "Id", "ManagesVpcEndpoints", "PrivateDnsName", "ServiceName", "ServiceType", "State"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_vpc_endpoint_service',
            }).encode(),
        )
