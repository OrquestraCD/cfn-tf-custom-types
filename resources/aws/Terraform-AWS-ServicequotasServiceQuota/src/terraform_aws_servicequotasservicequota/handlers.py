...
TYPE_NAME = "Terraform::AWS::ServicequotasServiceQuota"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        ...
                        if return_value_name in ["Adjustable", "Arn", "DefaultValue", "Id", "QuotaName", "RequestId", "RequestStatus", "ServiceName"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_servicequotas_service_quota',
            }).encode(),
        )
