...
TYPE_NAME = "Terraform::OpenTelekomCloud::VpcPeeringConnectionAccepterV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "Name", "PeerTenantId", "PeerVpcId", "Status", "VpcId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opentelekomcloud_vpc_peering_connection_accepter_v2',
            }).encode(),
        )
