...
TYPE_NAME = "Terraform::OpenTelekomCloud::NatDnatRuleV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CreatedAt", "FloatingIpAddress", "Id", "Status", "TenantId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opentelekomcloud_nat_dnat_rule_v2',
            }).encode(),
        )
