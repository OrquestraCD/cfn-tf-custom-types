...
TYPE_NAME = "Terraform::OpenTelekomCloud::ImsDataImageV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["DataOrigin", "DiskFormat", "Id", "ImageSize", "Visibility"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opentelekomcloud_ims_data_image_v2',
            }).encode(),
        )
