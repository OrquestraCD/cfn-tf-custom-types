...
TYPE_NAME = "Terraform::OpenTelekomCloud::RdsInstanceV3"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Created", "Id", "Nodes", "PrivateIps", "PublicIps"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opentelekomcloud_rds_instance_v3',
            }).encode(),
        )
