...
TYPE_NAME = "Terraform::OpenTelekomCloud::ComputeBmsServerV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AccessIpV4", "AccessIpV6", "ConfigDrive", "HostId", "HostStatus", "Id", "KernelId", "TenantId", "UserId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opentelekomcloud_compute_bms_server_v2',
            }).encode(),
        )
