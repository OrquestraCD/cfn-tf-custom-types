...
TYPE_NAME = "Terraform::OpenTelekomCloud::SfsFileSystemV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AccessRuleStatus", "ExportLocation", "Host", "Id", "ShareAccessId", "Status"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opentelekomcloud_sfs_file_system_v2',
            }).encode(),
        )
