...
TYPE_NAME = "Terraform::OpenTelekomCloud::DcsInstanceV1"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "InternalVersion", "Ip", "MaxMemory", "OrderId", "Port", "ResourceSpecCode", "SecurityGroupName", "SubnetName", "UsedMemory", "UserId", "VpcName"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opentelekomcloud_dcs_instance_v1',
            }).encode(),
        )
