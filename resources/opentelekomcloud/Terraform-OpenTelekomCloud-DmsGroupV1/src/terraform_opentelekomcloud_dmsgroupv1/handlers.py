...
TYPE_NAME = "Terraform::OpenTelekomCloud::DmsGroupV1"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AvailableDeadletters", "AvailableMessages", "ConsumedMessages", "Id", "ProducedDeadletters", "ProducedMessages"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opentelekomcloud_dms_group_v1',
            }).encode(),
        )
