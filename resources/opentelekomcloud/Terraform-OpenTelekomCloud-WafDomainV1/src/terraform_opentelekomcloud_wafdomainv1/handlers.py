...
TYPE_NAME = "Terraform::OpenTelekomCloud::WafDomainV1"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AccessCode", "AccessStatus", "Cname", "Id", "ProtectStatus", "Protocol", "SubDomain", "TxtCode"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opentelekomcloud_waf_domain_v1',
            }).encode(),
        )
