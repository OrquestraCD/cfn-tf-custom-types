...
TYPE_NAME = "Terraform::OpenTelekomCloud::CsbsBackupV1"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["BackupRecordId", "Id", "Status", "VmMetadata", "VolumeBackups"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opentelekomcloud_csbs_backup_v1',
            }).encode(),
        )
