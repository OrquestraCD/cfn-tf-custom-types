...
TYPE_NAME = "Terraform::OpenTelekomCloud::WafCcattackprotectionRuleV1"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Default", "Id"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opentelekomcloud_waf_ccattackprotection_rule_v1',
            }).encode(),
        )
