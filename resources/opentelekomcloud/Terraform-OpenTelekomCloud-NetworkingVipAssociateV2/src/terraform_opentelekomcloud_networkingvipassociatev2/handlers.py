...
TYPE_NAME = "Terraform::OpenTelekomCloud::NetworkingVipAssociateV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "VipIpAddress", "VipSubnetId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opentelekomcloud_networking_vip_associate_v2',
            }).encode(),
        )
