...
TYPE_NAME = "Terraform::OpenTelekomCloud::VbsBackupV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AvailabilityZone", "Container", "Id", "ServiceMetadata", "Size", "Status"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opentelekomcloud_vbs_backup_v2',
            }).encode(),
        )
