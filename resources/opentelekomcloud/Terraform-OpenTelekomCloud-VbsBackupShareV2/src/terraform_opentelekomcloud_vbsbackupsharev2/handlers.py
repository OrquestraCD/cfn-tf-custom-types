...
TYPE_NAME = "Terraform::OpenTelekomCloud::VbsBackupShareV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AvailabilityZone", "BackupName", "BackupStatus", "Container", "Description", "Id", "ServiceMetadata", "ShareIds", "Size", "SnapshotId", "VolumeId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'opentelekomcloud_vbs_backup_share_v2',
            }).encode(),
        )
