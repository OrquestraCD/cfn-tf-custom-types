...
TYPE_NAME = "Terraform::VCD::NetworkDirect"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["ExternalNetworkDns1", "ExternalNetworkDns2", "ExternalNetworkDnsSuffix", "ExternalNetworkGateway", "ExternalNetworkNetmask", "Id"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'vcd',
                'terraformTypeName': 'vcd_network_direct',
            }).encode(),
        )
