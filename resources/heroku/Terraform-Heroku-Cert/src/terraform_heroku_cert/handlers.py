...
TYPE_NAME = "Terraform::Heroku::Cert"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Cname", "Id", "Name"] and getattr(progress.resourceModel, return_value_name) is None:
