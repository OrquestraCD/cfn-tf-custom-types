...
TYPE_NAME = "Terraform::Heroku::Build"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "LocalChecksum", "OutputStreamUrl", "ReleaseId", "SlugId", "Stack", "Status", "User", "Uuid"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'heroku',
                'terraformTypeName': 'heroku_build',
            }).encode(),
        )
