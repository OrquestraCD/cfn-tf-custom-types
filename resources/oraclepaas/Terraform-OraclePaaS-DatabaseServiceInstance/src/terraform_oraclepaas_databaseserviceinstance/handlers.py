...
TYPE_NAME = "Terraform::OraclePaaS::DatabaseServiceInstance"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CloudStorageContainer", "ComputeSiteName", "DbaasMonitorUrl", "EmUrl", "GlassfishUrl", "Id", "IdentityDomain", "Status", "Uri"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'oraclepaas',
                'terraformTypeName': 'oraclepaas_database_service_instance',
            }).encode(),
        )
