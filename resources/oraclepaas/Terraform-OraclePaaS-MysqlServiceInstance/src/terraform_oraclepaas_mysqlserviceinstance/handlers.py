...
TYPE_NAME = "Terraform::OraclePaaS::MysqlServiceInstance"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["BaseReleaseVersion", "EmUrl", "Id", "ReleaseVersion", "ServiceVersion"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oraclepaas_mysql_service_instance',
            }).encode(),
        )
