...
TYPE_NAME = "Terraform::OraclePaaS::ApplicationContainer"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AppUrl", "Id", "WebUrl"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'oraclepaas_application_container',
            }).encode(),
        )
