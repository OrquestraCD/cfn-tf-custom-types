...
TYPE_NAME = "Terraform::Rancher::Certificate"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Algorithm", "CertFingerprint", "Cn", "ExpiresAt", "Id", "IssuedAt", "Issuer", "KeySize", "SerialNumber", "SubjectAlternativeNames", "Version"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'rancher',
                'terraformTypeName': 'rancher_certificate',
            }).encode(),
        )
