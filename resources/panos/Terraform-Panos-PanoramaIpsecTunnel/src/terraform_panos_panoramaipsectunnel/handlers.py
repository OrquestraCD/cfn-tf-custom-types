...
TYPE_NAME = "Terraform::Panos::PanoramaIpsecTunnel"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "MkAuthKeyEnc", "MkEspEncryptionKeyEnc"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'panos_panorama_ipsec_tunnel',
            }).encode(),
        )
