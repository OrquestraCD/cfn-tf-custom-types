...
TYPE_NAME = "Terraform::Panos::PanoramaHttpServerProfile"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "PasswordEnc", "PasswordRaw"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'panos_panorama_http_server_profile',
            }).encode(),
        )
