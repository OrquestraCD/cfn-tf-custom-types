...
TYPE_NAME = "Terraform::Panos::PanoramaSnmptrapServerProfile"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AuthPasswordEnc", "AuthPasswordRaw", "Id", "PrivPasswordEnc", "PrivPasswordRaw"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'panos',
                'terraformTypeName': 'panos_panorama_snmptrap_server_profile',
            }).encode(),
        )
