...
TYPE_NAME = "Terraform::CloudScale::Server"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Href", "Id", "PrivateIpv4Address", "PublicIpv4Address", "PublicIpv6Address", "ServerGroups", "SshFingerprints", "SshHostKeys", "Volumes"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'cloudscale',
                'terraformTypeName': 'cloudscale_server',
            }).encode(),
        )
