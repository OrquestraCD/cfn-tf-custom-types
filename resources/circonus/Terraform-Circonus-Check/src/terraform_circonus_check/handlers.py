...
TYPE_NAME = "Terraform::Circonus::Check"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CheckByCollector", "CheckId", "Checks", "Created", "Id", "LastModified", "LastModifiedBy", "ReverseConnectUrls", "Uuids"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'circonus',
                'terraformTypeName': 'circonus_check',
            }).encode(),
        )
