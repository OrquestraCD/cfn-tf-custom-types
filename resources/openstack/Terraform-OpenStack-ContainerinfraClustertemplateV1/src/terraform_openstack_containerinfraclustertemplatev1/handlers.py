...
TYPE_NAME = "Terraform::OpenStack::ContainerinfraClustertemplateV1"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CreatedAt", "Id", "ProjectId", "UpdatedAt", "UserId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'openstack_containerinfra_clustertemplate_v1',
            }).encode(),
        )
