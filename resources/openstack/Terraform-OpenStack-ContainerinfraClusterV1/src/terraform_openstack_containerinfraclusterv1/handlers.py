...
TYPE_NAME = "Terraform::OpenStack::ContainerinfraClusterV1"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["ApiAddress", "CoeVersion", "ContainerVersion", "CreatedAt", "Id", "MasterAddresses", "NodeAddresses", "ProjectId", "StackId", "UpdatedAt", "UserId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'openstack',
                'terraformTypeName': 'openstack_containerinfra_cluster_v1',
            }).encode(),
        )
