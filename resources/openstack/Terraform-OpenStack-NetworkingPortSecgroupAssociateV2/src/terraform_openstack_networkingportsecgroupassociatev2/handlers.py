...
TYPE_NAME = "Terraform::OpenStack::NetworkingPortSecgroupAssociateV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AllSecurityGroupIds", "Id"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'openstack_networking_port_secgroup_associate_v2',
            }).encode(),
        )
