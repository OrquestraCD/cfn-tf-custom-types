...
TYPE_NAME = "Terraform::OpenStack::NetworkingSubnetpoolV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AllTags", "CreatedAt", "Id", "RevisionNumber", "UpdatedAt"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'openstack_networking_subnetpool_v2',
            }).encode(),
        )
