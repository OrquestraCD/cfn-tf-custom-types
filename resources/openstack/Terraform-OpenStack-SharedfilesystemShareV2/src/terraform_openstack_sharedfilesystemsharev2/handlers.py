...
TYPE_NAME = "Terraform::OpenStack::SharedfilesystemShareV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AllMetadata", "ExportLocations", "HasReplicas", "Host", "Id", "ProjectId", "ReplicationType", "ShareServerId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'openstack_sharedfilesystem_share_v2',
            }).encode(),
        )
