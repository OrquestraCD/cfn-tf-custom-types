...
TYPE_NAME = "Terraform::OpenStack::ImagesImageV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Checksum", "CreatedAt", "File", "Id", "Metadata", "Owner", "Schema", "SizeBytes", "Status", "UpdateAt", "UpdatedAt"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'openstack_images_image_v2',
            }).encode(),
        )
