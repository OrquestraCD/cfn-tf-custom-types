...
TYPE_NAME = "Terraform::TLS::PrivateKey"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "PrivateKeyPem", "PublicKeyFingerprintMd5", "PublicKeyOpenssh", "PublicKeyPem"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'tls_private_key',
            }).encode(),
        )
