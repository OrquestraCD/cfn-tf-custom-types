...
TYPE_NAME = "Terraform::HCloud::Server"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["BackupWindow", "Id", "Ipv4Address", "Ipv6Address", "Ipv6Network", "Status"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'hcloud',
                'terraformTypeName': 'hcloud_server',
            }).encode(),
        )
