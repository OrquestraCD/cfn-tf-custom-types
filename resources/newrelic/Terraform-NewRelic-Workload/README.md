# Terraform::NewRelic::Workload

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-newrelic-workload.json`
2. Implement your resource handlers in `terraform_newrelic_workload/handlers.py`
