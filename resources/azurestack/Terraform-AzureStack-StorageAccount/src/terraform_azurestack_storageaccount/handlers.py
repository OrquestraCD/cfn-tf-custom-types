...
TYPE_NAME = "Terraform::AzureStack::StorageAccount"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "PrimaryAccessKey", "PrimaryBlobConnectionString", "PrimaryBlobEndpoint", "PrimaryConnectionString", "PrimaryFileEndpoint", "PrimaryLocation", "PrimaryQueueEndpoint", "PrimaryTableEndpoint", "SecondaryAccessKey", "SecondaryBlobConnectionString", "SecondaryBlobEndpoint", "SecondaryConnectionString", "SecondaryLocation", "SecondaryQueueEndpoint", "SecondaryTableEndpoint"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'azurestack',
                'terraformTypeName': 'azurestack_storage_account',
            }).encode(),
        )
