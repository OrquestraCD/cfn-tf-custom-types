# Terraform::Consul::Namespace

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-consul-namespace.json`
2. Implement your resource handlers in `terraform_consul_namespace/handlers.py`
