# Terraform::Consul::NetworkArea

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-consul-networkarea.json`
2. Implement your resource handlers in `terraform_consul_networkarea/handlers.py`
