...
TYPE_NAME = "Terraform::Consul::License"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'consul_license',
                'returnValues': ["CustomerId", "ExpirationTime", "Features", "Flags", "Id", "InstallationId", "IssueTime", "LicenseId", "Product", "StartTime", "Valid", "Warnings"],
            }).encode(),
        )
