...
TYPE_NAME = "Terraform::TencentCloud::ScfFunction"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CodeError", "CodeResult", "CodeSize", "EipFixed", "Eips", "ErrNo", "Host", "Id", "InstallDependency", "ModifyTime", "Status", "StatusDesc", "TriggerInfo", "Vip"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'tencentcloud_scf_function',
            }).encode(),
        )
