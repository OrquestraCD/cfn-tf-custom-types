...
TYPE_NAME = "Terraform::TencentCloud::KubernetesCluster"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CertificationAuthority", "ClusterExternalEndpoint", "ClusterNodeNum", "Domain", "Id", "Password", "PgwEndpoint", "SecurityPolicy", "UserName", "WorkerInstancesList"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'tencentcloud',
                'terraformTypeName': 'tencentcloud_kubernetes_cluster',
            }).encode(),
        )
