...
TYPE_NAME = "Terraform::TencentCloud::GaapCertificate"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["BeginTime", "CreateTime", "EndTime", "Id", "IssuerCn", "SubjectCn"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'tencentcloud_gaap_certificate',
            }).encode(),
        )
