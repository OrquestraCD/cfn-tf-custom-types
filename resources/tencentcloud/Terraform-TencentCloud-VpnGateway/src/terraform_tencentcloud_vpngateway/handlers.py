...
TYPE_NAME = "Terraform::TencentCloud::VpnGateway"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CreateTime", "ExpiredTime", "Id", "IsAddressBlocked", "NewPurchasePlan", "PublicIpAddress", "RestrictState", "State", "Type"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'tencentcloud_vpn_gateway',
            }).encode(),
        )
