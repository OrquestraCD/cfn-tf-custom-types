...
TYPE_NAME = "Terraform::TencentCloud::TcaplusApplication"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["ApiAccessId", "ApiAccessIp", "ApiAccessPort", "CreateTime", "Id", "NetworkType", "OldPasswordExpireTime", "PasswordStatus"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'tencentcloud_tcaplus_application',
            }).encode(),
        )
