...
TYPE_NAME = "Terraform::TencentCloud::MysqlInstance"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Gtid", "Id", "InternetHost", "InternetPort", "IntranetIp", "Locked", "Status", "TaskStatus"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'tencentcloud_mysql_instance',
            }).encode(),
        )
