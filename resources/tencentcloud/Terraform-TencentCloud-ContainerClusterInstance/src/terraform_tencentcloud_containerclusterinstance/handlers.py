...
TYPE_NAME = "Terraform::TencentCloud::ContainerClusterInstance"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AbnormalReason", "Id", "InstanceId", "IsNormal", "LanIp", "WanIp"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'tencentcloud_container_cluster_instance',
            }).encode(),
        )
