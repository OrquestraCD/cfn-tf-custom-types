...
TYPE_NAME = "Terraform::AzureRM::FunctionApp"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["DefaultHostname", "Id", "Kind", "OutboundIpAddresses", "PossibleOutboundIpAddresses", "SiteCredential"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'azurerm_function_app',
            }).encode(),
        )
