...
TYPE_NAME = "Terraform::AzureRM::DevTestLab"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["ArtifactsStorageAccountId", "DefaultPremiumStorageAccountId", "DefaultStorageAccountId", "Id", "KeyVaultId", "PremiumDataDiskStorageAccountId", "UniqueIdentifier"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'azurerm_dev_test_lab',
            }).encode(),
        )
