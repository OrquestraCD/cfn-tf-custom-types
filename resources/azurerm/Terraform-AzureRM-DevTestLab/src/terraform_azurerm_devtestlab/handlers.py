    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["ArtifactsStorageAccountId", "DefaultPremiumStorageAccountId", "DefaultStorageAccountId", "Id", "KeyVaultId", "PremiumDataDiskStorageAccountId", "UniqueIdentifier"],
            }).encode(),
        )
