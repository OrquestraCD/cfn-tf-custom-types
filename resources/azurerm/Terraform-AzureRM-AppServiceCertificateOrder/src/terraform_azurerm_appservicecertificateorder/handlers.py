    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["AppServiceCertificateNotRenewableReasons", "Certificates", "DomainVerificationToken", "ExpirationTime", "Id", "IntermediateThumbprint", "IsPrivateKeyExternal", "RootThumbprint", "SignedCertificateThumbprint", "Status"],
            }).encode(),
        )
