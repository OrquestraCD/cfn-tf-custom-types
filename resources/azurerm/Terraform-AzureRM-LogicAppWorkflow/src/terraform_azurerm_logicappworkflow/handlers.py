...
TYPE_NAME = "Terraform::AzureRM::LogicAppWorkflow"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AccessEndpoint", "ConnectorEndpointIpAddresses", "ConnectorOutboundIpAddresses", "Id", "WorkflowEndpointIpAddresses", "WorkflowOutboundIpAddresses"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'azurerm_logic_app_workflow',
            }).encode(),
        )
