...
TYPE_NAME = "Terraform::AzureRM::KustoDatabasePrincipal"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AppId", "Email", "FullyQualifiedName", "Id", "Name"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'azurerm_kusto_database_principal',
            }).encode(),
        )
