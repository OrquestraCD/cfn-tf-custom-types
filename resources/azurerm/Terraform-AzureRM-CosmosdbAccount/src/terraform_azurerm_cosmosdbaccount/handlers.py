...
TYPE_NAME = "Terraform::AzureRM::CosmosdbAccount"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["ConnectionStrings", "Endpoint", "Id", "PrimaryMasterKey", "PrimaryReadonlyMasterKey", "ReadEndpoints", "SecondaryMasterKey", "SecondaryReadonlyMasterKey", "WriteEndpoints"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'azurerm_cosmosdb_account',
            }).encode(),
        )
