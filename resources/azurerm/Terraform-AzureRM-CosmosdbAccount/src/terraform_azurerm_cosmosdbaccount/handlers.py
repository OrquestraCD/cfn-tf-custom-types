    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["ConnectionStrings", "Endpoint", "Id", "PrimaryMasterKey", "PrimaryReadonlyMasterKey", "ReadEndpoints", "SecondaryMasterKey", "SecondaryReadonlyMasterKey", "WriteEndpoints"],
            }).encode(),
        )
