...
TYPE_NAME = "Terraform::AzureRM::LogAnalyticsWorkspace"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "PortalUrl", "PrimarySharedKey", "SecondarySharedKey", "WorkspaceId"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'azurerm_log_analytics_workspace',
            }).encode(),
        )
