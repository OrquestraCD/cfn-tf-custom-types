...
TYPE_NAME = "Terraform::AzureRM::SignalrService"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Hostname", "Id", "IpAddress", "PrimaryAccessKey", "PrimaryConnectionString", "PublicPort", "SecondaryAccessKey", "SecondaryConnectionString", "ServerPort"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'azurerm_signalr_service',
            }).encode(),
        )
