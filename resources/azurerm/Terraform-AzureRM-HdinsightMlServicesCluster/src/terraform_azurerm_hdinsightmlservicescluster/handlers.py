...
TYPE_NAME = "Terraform::AzureRM::HdinsightMlServicesCluster"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["EdgeSshEndpoint", "HttpsEndpoint", "Id", "SshEndpoint"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'azurerm_hdinsight_ml_services_cluster',
            }).encode(),
        )
