...
TYPE_NAME = "Terraform::AzureRM::ApplicationInsightsAnalyticsItem"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "TimeCreated", "TimeModified", "Version"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'azurerm_application_insights_analytics_item',
            }).encode(),
        )
