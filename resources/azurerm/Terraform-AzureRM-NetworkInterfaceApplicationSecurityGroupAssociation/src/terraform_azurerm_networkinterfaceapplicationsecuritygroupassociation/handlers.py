...
TYPE_NAME = "Terraform::AzureRM::NetworkInterfaceApplicationSecurityGroupAssociation"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'azurerm_network_interface_application_security_group_association',
            }).encode(),
        )
