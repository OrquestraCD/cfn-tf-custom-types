...
1. Write the JSON schema describing your resource, `terraform-azurerm-mssqldatabase.json`
2. Implement your resource handlers in `terraform_azurerm_mssqldatabase/handlers.py`
