...
TYPE_NAME = "Terraform::AzureRM::ExpressRouteCircuitAuthorization"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AuthorizationKey", "AuthorizationUseStatus", "Id"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'azurerm_express_route_circuit_authorization',
            }).encode(),
        )
