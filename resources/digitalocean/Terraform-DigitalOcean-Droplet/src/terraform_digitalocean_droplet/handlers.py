...
TYPE_NAME = "Terraform::DigitalOcean::Droplet"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CreatedAt", "Disk", "Id", "Ipv4Address", "Ipv4AddressPrivate", "Ipv6Address", "Ipv6AddressPrivate", "Locked", "Memory", "PriceHourly", "PriceMonthly", "Status", "Urn", "Vcpus"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'digitalocean',
                'terraformTypeName': 'digitalocean_droplet',
            }).encode(),
        )
