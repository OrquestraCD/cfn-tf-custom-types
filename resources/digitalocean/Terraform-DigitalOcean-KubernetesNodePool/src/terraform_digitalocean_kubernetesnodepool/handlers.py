...
TYPE_NAME = "Terraform::DigitalOcean::KubernetesNodePool"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["ActualNodeCount", "Id", "Nodes"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'digitalocean_kubernetes_node_pool',
            }).encode(),
        )
