...
TYPE_NAME = "Terraform::Vault::PkiSecretBackendIntermediateCertRequest"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Csr", "Id", "PrivateKey", "PrivateKeyType"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'vault_pki_secret_backend_intermediate_cert_request',
            }).encode(),
        )
