...
TYPE_NAME = "Terraform::Linode::Stackscript"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Created", "DeploymentsActive", "DeploymentsTotal", "Id", "Updated", "UserGravatarId", "Username"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'linode',
                'terraformTypeName': 'linode_stackscript',
            }).encode(),
        )
