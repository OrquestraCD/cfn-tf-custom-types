...
TYPE_NAME = "Terraform::Linode::Image"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Created", "CreatedBy", "Deprecated", "Expiry", "Id", "IsPublic", "Size", "Type", "Vendor"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'linode_image',
            }).encode(),
        )
