...
TYPE_NAME = "Terraform::Google::StorageDefaultObjectAccessControl"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Domain", "Email", "EntityId", "Generation", "Id", "ProjectTeam"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'google_storage_default_object_access_control',
            }).encode(),
        )
