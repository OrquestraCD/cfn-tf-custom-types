...
class ResourceModel(BaseResourceModel):
    ...
    SourceInstanceTemplate: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            SourceInstanceTemplate=json_data.get("SourceInstanceTemplate"),
...
class AttachedDisk:
    ...
    DiskEncryptionKeySha256: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DiskEncryptionKeySha256=json_data.get("DiskEncryptionKeySha256"),
