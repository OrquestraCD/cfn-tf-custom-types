...
TYPE_NAME = "Terraform::Google::ComputeInstanceFromTemplate"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CpuPlatform", "CurrentStatus", "Id", "InstanceId", "LabelFingerprint", "MetadataFingerprint", "SelfLink", "TagsFingerprint"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'google_compute_instance_from_template',
            }).encode(),
        )
