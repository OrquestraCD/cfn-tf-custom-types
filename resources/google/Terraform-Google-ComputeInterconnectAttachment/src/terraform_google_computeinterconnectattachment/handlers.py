    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["CloudRouterIpAddress", "CreationTimestamp", "CustomerRouterIpAddress", "GoogleReferenceId", "Id", "PairingKey", "PartnerAsn", "PrivateInterconnectInfo", "SelfLink", "State"],
            }).encode(),
        )
