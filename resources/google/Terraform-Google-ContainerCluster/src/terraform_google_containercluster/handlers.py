...
TYPE_NAME = "Terraform::Google::ContainerCluster"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Endpoint", "Id", "InstanceGroupUrls", "LabelFingerprint", "MasterVersion", "Operation", "ServicesIpv4Cidr"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'google_container_cluster',
            }).encode(),
        )
