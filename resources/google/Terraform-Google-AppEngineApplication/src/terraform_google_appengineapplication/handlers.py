...
TYPE_NAME = "Terraform::Google::AppEngineApplication"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AppId", "CodeBucket", "DefaultBucket", "DefaultHostname", "GcrDomain", "Id", "Name", "UrlDispatchRule"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'google_app_engine_application',
            }).encode(),
        )
