...
TYPE_NAME = "Terraform::Google::IdentityPlatformTenantDefaultSupportedIdpConfig"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Id", "Name"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'google_identity_platform_tenant_default_supported_idp_config',
            }).encode(),
        )
