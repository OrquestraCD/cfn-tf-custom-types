# Terraform::Google::ComputeRegionSslCertificate

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-google-computeregionsslcertificate.json`
2. Implement your resource handlers in `terraform_google_computeregionsslcertificate/handlers.py`
