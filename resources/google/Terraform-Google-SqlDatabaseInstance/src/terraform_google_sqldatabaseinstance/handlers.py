...
TYPE_NAME = "Terraform::Google::SqlDatabaseInstance"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["ConnectionName", "FirstIpAddress", "Id", "IpAddress", "PrivateIpAddress", "PublicIpAddress", "SelfLink", "ServerCaCert", "ServiceAccountEmailAddress"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'google_sql_database_instance',
            }).encode(),
        )
