...
TYPE_NAME = "Terraform::HuaweiCloud::DmsInstanceV1"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["ConnectAddress", "CreatedAt", "Id", "OrderId", "Port", "ResourceSpecCode", "SecurityGroupName", "Status", "SubnetName", "Type", "UsedStorageSpace", "UserId", "VpcName"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'huaweicloud_dms_instance_v1',
            }).encode(),
        )
