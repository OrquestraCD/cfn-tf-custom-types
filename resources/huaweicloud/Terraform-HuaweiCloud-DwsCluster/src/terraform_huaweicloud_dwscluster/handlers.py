...
TYPE_NAME = "Terraform::HuaweiCloud::DwsCluster"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Created", "Endpoints", "Id", "PublicEndpoints", "RecentEvent", "Status", "SubStatus", "TaskStatus", "Updated", "Version"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'huaweicloud_dws_cluster',
            }).encode(),
        )
