...
TYPE_NAME = "Terraform::HuaweiCloud::KmsKeyV1"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CreationDate", "DefaultKeyFlag", "DomainId", "ExpirationTime", "Id", "KeyId", "ScheduledDeletionDate"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'huaweicloud_kms_key_v1',
            }).encode(),
        )
