...
TYPE_NAME = "Terraform::HuaweiCloud::ElbBackendecs"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["CreateTime", "HealthStatus", "Id", "Listeners", "PublicAddress", "ServerName", "Status", "UpdateTime"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'huaweicloud_elb_backendecs',
            }).encode(),
        )
