...
TYPE_NAME = "Terraform::HuaweiCloud::CloudtableClusterV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Created", "HbasePublicEndpoint", "Id", "LemonLink", "OpenTsdbLink", "OpentsdbPublicEndpoint", "StorageQuota", "UsedStorageSize", "ZookeeperLink"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'huaweicloud_cloudtable_cluster_v2',
            }).encode(),
        )
