...
TYPE_NAME = "Terraform::HuaweiCloud::NetworkingPortV2"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AllFixedIps", "AllSecurityGroupIds", "Id"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'huaweicloud_networking_port_v2',
            }).encode(),
        )
