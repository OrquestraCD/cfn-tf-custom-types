...
TYPE_NAME = "Terraform::HuaweiCloud::MlsInstance"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Created", "CurrentTask", "Id", "InnerEndpoint", "PublicEndpoint", "Status", "Updated"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'huaweicloud_mls_instance',
            }).encode(),
        )
