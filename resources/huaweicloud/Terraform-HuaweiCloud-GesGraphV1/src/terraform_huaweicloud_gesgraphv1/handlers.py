...
TYPE_NAME = "Terraform::HuaweiCloud::GesGraphV1"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["Created", "EdgesetPath", "Id", "PrivateIp", "PublicIp", "SchemaPath", "Version", "VertexsetPath"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'huaweicloud_ges_graph_v1',
            }).encode(),
        )
