...
TYPE_NAME = "Terraform::OVH::MeInstallationTemplatePartitionSchemeHardwareRaid"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'ovh_me_installation_template_partition_scheme_hardware_raid',
            }).encode(),
        )
