    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["AvailableLanguages", "Beta", "BitFormat", "Category", "Deprecated", "Description", "Distribution", "Family", "Filesystems", "HardRaidConfiguration", "Id", "LastModification", "SupportsDistributionKernel", "SupportsGptLabel", "SupportsRtm", "SupportsSqlServer", "SupportsUefi"],
            }).encode(),
        )
