...
TYPE_NAME = "Terraform::OVH::MeInstallationTemplate"
            ...
            try:
                if 'returnValues' in result:
                    for return_value_name, return_value_value in result['returnValues'].items():
                        if return_value_name in ["AvailableLanguages", "Beta", "BitFormat", "Category", "Deprecated", "Description", "Distribution", "Family", "Filesystems", "HardRaidConfiguration", "Id", "LastModification", "SupportsDistributionKernel", "SupportsGptLabel", "SupportsRtm", "SupportsSqlServer", "SupportsUefi"] and getattr(progress.resourceModel, return_value_name) is None:
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerTypeName': 'ovh',
                'terraformTypeName': 'ovh_me_installation_template',
            }).encode(),
        )
